    ...
    <div className="bg-indigo-200 min-h-screen flex flex-col justify-between">
      ...
      <div className="flex justify-center">
        <div className="w-full sm:w-3/4 bg-white rounded-lg p-6 mt-24 mb-4">
          ...
          <div>
            <span className="text-base font-bold ">Уважаемые соискатели</span> отправляя резюме, Вы
            не получите гарантию трудоустройства. Ваше резюме поступит мне, я его опубликую на
            сайте. Данная инициатива добровольна, направлена чтобы помочь. При позникновении
            вопросов пишите на почту hirepeoplewithdisabilities@gmail.com .
          </div>
        </div>
      </div>
      <div>
