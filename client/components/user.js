        ...
        <div className="md:w-4/5">
          {users.map((it) => {
            return (
              <div
                key={it}
                className="md:flex bg-white sm:text-2xl text-xl rounded-lg  mb-4 shadow-lg "
              >
                <div className="flex flex-col w-full">
                  <img
                    ...
                    alt=""
                  />
                  <h2 className=" sm:text-5xl text-3xl flex justify-center capitalize">
                  ...
                  <div className="flex flex-col flex-start justify-between pl-4">
                    <div className="text-purple-700 w-full flex flex-wrap mb-4">
                      ...
                      {it.skills.map((item) => {
                        return (
                          <div key={item.id} className="flex mr-4 capitalize">
                            {item}
                          </div>
                        )
                      })}
                    ...
                    <div className="w-full mb-4 ">
                      <div className="text-gray-800 flex flex-wrap">
                        ...
                        <div className="text-gray-900 bold sm:w-2/3 w-full capitalize">
                          {it.condition}
                        </div>
                      </div>
                    </div>
